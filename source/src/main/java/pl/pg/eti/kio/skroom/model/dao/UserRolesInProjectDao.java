...
public class UserRolesInProjectDao {
    ...
    public List<UserRolesInProject> listAllUserRolesInProject(
        ...
        List<UserRolesInProject> userRolesInProjects = new ArrayList<
            UserRolesInProject
        >();

        Result<UserRolesInProjectRecord> records = query
            .selectFrom(Tables.USER_ROLES_IN_PROJECT)
            .fetch();
    ...
    public UserRolesInProject fetchById(Connection connection, int id) {
        ...
        UserRolesInProjectRecord record = query
            .selectFrom(USER_ROLES_IN_PROJECT)
    ...
    public boolean update(
        ...
        int updatedRows = query
            ...
            .set(
                ...
                userRolesInProject.isPrivileges() ? 1 : 0
            )
    ...
    public boolean insert(
        ...
        int updatedRows = query
            ...
            .values(
                userRolesInProject.getRole(),
                userRolesInProject.getColor(),
                userRolesInProject.isPrivileges() ? 1 : 0
            )
            .execute();
    ...
    public boolean remove(Connection connection, Integer userRoleInProjectId) {
        ...
        int deletedUserRoles = query
            .delete(Tables.USERS_PROJECTS)
            .where(Tables.USERS_PROJECTS.USER_ROLE_ID.eq(userRoleInProjectId))
            .execute();

        int updatedRows = query
            .delete(USER_ROLES_IN_PROJECT)
