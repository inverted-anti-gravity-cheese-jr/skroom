...
public class Projects extends TableImpl<ProjectsRecord> {
     ...
     */
    public final TableField<ProjectsRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<ProjectsRecord, String> NAME = createField(
        "NAME",
     ...
     */
    public final TableField<ProjectsRecord, String> DESCRIPTION = createField(
        "DESCRIPTION",
        org.jooq.impl.SQLDataType.CLOB,
        this,
        ""
     ...
     */
    public final TableField<ProjectsRecord, Integer> DEFAULT_SPRINT_LENGTH =
        createField(
