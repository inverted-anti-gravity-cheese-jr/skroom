...
public class Sprints extends TableImpl<SprintsRecord> {
     ...
     */
    public final TableField<SprintsRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<SprintsRecord, String> NAME = createField(
        "NAME",
     ...
     */
    public final TableField<SprintsRecord, Date> START_DAY = createField(
        "START_DAY",
     ...
     */
    public final TableField<SprintsRecord, Date> END_DAY = createField(
        "END_DAY",
        org.jooq.impl.SQLDataType.DATE,
        this,
        ""
     ...
     */
    public final TableField<SprintsRecord, Integer> PROJECT_ID = createField(
        "PROJECT_ID",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
    ...
    public List<ForeignKey<SprintsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<SprintsRecord, ?>>asList(
            Keys.FK_SPRINTS_PROJECTS_1
        );
    }
