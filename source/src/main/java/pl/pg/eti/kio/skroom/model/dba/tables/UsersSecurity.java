...
public class UsersSecurity extends TableImpl<UsersSecurityRecord> {
     ...
     */
    public final TableField<UsersSecurityRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<UsersSecurityRecord, Integer> USER_ID = createField(
        "USER_ID",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<UsersSecurityRecord, String> PASSWORD = createField(
        "PASSWORD",
     ...
     */
    public final TableField<UsersSecurityRecord, String> SALT = createField(
        "SALT",
        org.jooq.impl.SQLDataType.CLOB,
        this,
        ""
     ...
     */
    public final TableField<UsersSecurityRecord, String> SECURE_QUESTION =
        createField(
            "SECURE_QUESTION",
            org.jooq.impl.SQLDataType.CLOB,
            this,
     ...
     */
    public final TableField<UsersSecurityRecord, String> SECURE_ANSWER =
        createField("SECURE_ANSWER", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>USERS_SECURITY.ACCEPTED</code>.
     */
    public final TableField<UsersSecurityRecord, Integer> ACCEPTED =
        createField("ACCEPTED", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    private UsersSecurity(
        String alias,
        Table<UsersSecurityRecord> aliased,
        Field<?>[] parameters
    ) {
    ...
    public List<UniqueKey<UsersSecurityRecord>> getKeys() {
        return Arrays.<UniqueKey<UsersSecurityRecord>>asList(
            Keys.PK_USERS_SECURITY
        );
    }
    ...
    public List<ForeignKey<UsersSecurityRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UsersSecurityRecord, ?>>asList(
            Keys.FK_USERS_SECURITY_USERS_1
        );
    }
