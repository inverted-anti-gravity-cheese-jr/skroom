...
public class UserStoryStatusDao {
    ...
    public UserStoryStatus getUserStoryStatusForName(
        ...
        UserStoryStatusRecord storyStatusRecord = query
            .selectFrom(Tables.USER_STORY_STATUS)
            .where(Tables.USER_STORY_STATUS.STATUS_NAME.eq(name))
            .fetchOne();
    ...
    public ArrayList<UserStoryStatus> listAllStatuses(Connection connection) {
        ...
        Result<UserStoryStatusRecord> storyStatusRecords = query
            .selectFrom(Tables.USER_STORY_STATUS)
            .fetch();
