...
public class UsersProjects extends TableImpl<UsersProjectsRecord> {
    ...
    private static final long serialVersionUID = 213244386;
     ...
     */
    public final TableField<UsersProjectsRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<UsersProjectsRecord, Integer> USER_ID = createField(
        "USER_ID",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<UsersProjectsRecord, Integer> PROJECT_ID =
        createField("PROJECT_ID", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>USERS_PROJECTS.USER_ROLE_ID</code>.
     */
    public final TableField<UsersProjectsRecord, Integer> USER_ROLE_ID =
        createField(
            "USER_ROLE_ID",
            org.jooq.impl.SQLDataType.INTEGER,
            this,
    ...
    private UsersProjects(
        String alias,
        Table<UsersProjectsRecord> aliased,
        Field<?>[] parameters
    ) {
     ...
     */
    @Override
    public Identity<UsersProjectsRecord, Integer> getIdentity() {
        return Keys.IDENTITY_USERS_PROJECTS;
    }
    ...
    public List<UniqueKey<UsersProjectsRecord>> getKeys() {
        return Arrays.<UniqueKey<UsersProjectsRecord>>asList(
            Keys.PK_USERS_PROJECTS
        );
    }
    ...
    public List<ForeignKey<UsersProjectsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UsersProjectsRecord, ?>>asList(
            Keys.FK_USERS_PROJECTS_USERS_1,
            Keys.FK_USERS_PROJECTS_PROJECTS_1,
            Keys.FK_USERS_PROJECTS_USER_ROLES_IN_PROJECT_1
        );
    }
