...
public class SqliteSequence extends TableImpl<SqliteSequenceRecord> {
     ...
     */
    public final TableField<SqliteSequenceRecord, Object> NAME = createField(
        "name",
     ...
     */
    public final TableField<SqliteSequenceRecord, Object> SEQ = createField(
        "seq",
        org.jooq.impl.DefaultDataType.getDefaultDataType(""),
        this,
        ""
    ...
    private SqliteSequence(
        String alias,
        Table<SqliteSequenceRecord> aliased,
        Field<?>[] parameters
    ) {
