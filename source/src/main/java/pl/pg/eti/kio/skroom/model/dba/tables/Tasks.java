...
public class Tasks extends TableImpl<TasksRecord> {
     ...
     */
    public final TableField<TasksRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<TasksRecord, String> NAME = createField(
        "NAME",
     ...
     */
    public final TableField<TasksRecord, String> DESCRIPTION = createField(
        "DESCRIPTION",
        org.jooq.impl.SQLDataType.CLOB,
        this,
        ""
     ...
     */
    public final TableField<TasksRecord, String> COLOR = createField(
        "COLOR",
        org.jooq.impl.SQLDataType.CLOB,
        this,
        ""
     ...
     */
    public final TableField<TasksRecord, Integer> ASSIGNEE = createField(
        "ASSIGNEE",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<TasksRecord, Integer> TASK_STATUS_ID = createField(
        "TASK_STATUS_ID",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<TasksRecord, Integer> ESTIMATED_TIME = createField(
        "ESTIMATED_TIME",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<TasksRecord, Integer> PROJECT_ID = createField(
        "PROJECT_ID",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<TasksRecord, Integer> USER_STORY_ID = createField(
        "USER_STORY_ID",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<TasksRecord, Integer> SPRINT_ID = createField(
        "SPRINT_ID",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
    ...
    public List<ForeignKey<TasksRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TasksRecord, ?>>asList(
            Keys.FK_TASKS_USERS_1,
            Keys.FK_TASKS_TASK_STATUSES_1,
            Keys.FK_TASKS_PROJECTS_1,
            Keys.FK_TASKS_USER_STORIES_1,
            Keys.FK_TASKS_SPRINTS_1
        );
    }
