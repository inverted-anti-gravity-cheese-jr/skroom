...
public class UserRolesInProject extends TableImpl<UserRolesInProjectRecord> {
     ...
     */
    public final TableField<UserRolesInProjectRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<UserRolesInProjectRecord, String> ROLE =
        createField("ROLE", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>USER_ROLES_IN_PROJECT.COLOR</code>.
     */
    public final TableField<UserRolesInProjectRecord, String> COLOR =
        createField("COLOR", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>USER_ROLES_IN_PROJECT.PRIVILIGES</code>.
     */
    public final TableField<UserRolesInProjectRecord, Integer> PRIVILIGES =
        createField("PRIVILIGES", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    private UserRolesInProject(
        String alias,
        Table<UserRolesInProjectRecord> aliased
    ) {
    ...
    public List<UniqueKey<UserRolesInProjectRecord>> getKeys() {
        return Arrays.<UniqueKey<UserRolesInProjectRecord>>asList(
            Keys.PK_USER_ROLES_IN_PROJECT
        );
    }
