...
public class UserStories extends TableImpl<UserStoriesRecord> {
     ...
     */
    public final TableField<UserStoriesRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<UserStoriesRecord, String> NAME = createField(
        "NAME",
     ...
     */
    public final TableField<UserStoriesRecord, String> AS_A_STORY = createField(
        "AS_A_STORY",
        org.jooq.impl.SQLDataType.CLOB,
        this,
        ""
     ...
     */
    public final TableField<UserStoriesRecord, String> I_WANT_TO_STORY =
        createField(
            "I_WANT_TO_STORY",
            org.jooq.impl.SQLDataType.CLOB,
            this,
     ...
     */
    public final TableField<UserStoriesRecord, String> SO_THAT_STORY =
        createField("SO_THAT_STORY", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>USER_STORIES.DESCRIPTION</code>.
     */
    public final TableField<UserStoriesRecord, String> DESCRIPTION =
        createField("DESCRIPTION", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>USER_STORIES.PRIORITY</code>.
     */
    public final TableField<UserStoriesRecord, Integer> PRIORITY = createField(
        "PRIORITY",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<UserStoriesRecord, Integer> STORY_POINTS =
        createField(
            "STORY_POINTS",
            org.jooq.impl.SQLDataType.INTEGER,
            this,
     ...
     */
    public final TableField<UserStoriesRecord, Integer> STATUS_ID = createField(
        "STATUS_ID",
        org.jooq.impl.SQLDataType.INTEGER,
        this,
        ""
     ...
     */
    public final TableField<UserStoriesRecord, Integer> PROJECT_ID =
        createField("PROJECT_ID", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    private UserStories(
        String alias,
        Table<UserStoriesRecord> aliased,
        Field<?>[] parameters
    ) {
    ...
    public List<UniqueKey<UserStoriesRecord>> getKeys() {
        return Arrays.<UniqueKey<UserStoriesRecord>>asList(
            Keys.PK_USER_STORIES
        );
    }
    ...
    public List<ForeignKey<UserStoriesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<UserStoriesRecord, ?>>asList(
            Keys.FK_USER_STORIES_USER_STORY_STATUS_1,
            Keys.FK_USER_STORIES_PROJECTS_1
        );
    }
