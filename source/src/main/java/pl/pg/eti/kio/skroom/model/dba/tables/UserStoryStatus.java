...
public class UserStoryStatus extends TableImpl<UserStoryStatusRecord> {
     ...
     */
    public final TableField<UserStoryStatusRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<UserStoryStatusRecord, String> STATUS_NAME =
        createField("STATUS_NAME", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>USER_STORY_STATUS.COLOR</code>.
     */
    public final TableField<UserStoryStatusRecord, String> COLOR = createField(
        "COLOR",
     ...
     */
    public final TableField<UserStoryStatusRecord, Integer> IS_ARCHIVE =
        createField("IS_ARCHIVE", org.jooq.impl.SQLDataType.INTEGER, this, "");
    ...
    private UserStoryStatus(
        String alias,
        Table<UserStoryStatusRecord> aliased
    ) {
    ...
    public List<UniqueKey<UserStoryStatusRecord>> getKeys() {
        return Arrays.<UniqueKey<UserStoryStatusRecord>>asList(
            Keys.PK_USER_STORY_STATUS
        );
    }
