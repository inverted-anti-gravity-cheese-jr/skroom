...
public class TaskStatuses extends TableImpl<TaskStatusesRecord> {
     ...
     */
    public final TableField<TaskStatusesRecord, Integer> ID = createField(
        "ID",
     ...
     */
    public final TableField<TaskStatusesRecord, String> NAME = createField(
        "NAME",
     ...
     */
    public final TableField<TaskStatusesRecord, Integer> STAYS_IN_SPRINT =
        createField(
            "STAYS_IN_SPRINT",
            org.jooq.impl.SQLDataType.INTEGER,
            this,
     ...
     */
    public final TableField<TaskStatusesRecord, Integer> PROJECT_ID =
    ...
    private TaskStatuses(
        String alias,
        Table<TaskStatusesRecord> aliased,
        Field<?>[] parameters
    ) {
    ...
    public List<UniqueKey<TaskStatusesRecord>> getKeys() {
        return Arrays.<UniqueKey<TaskStatusesRecord>>asList(
            Keys.PK_TASK_STATUSES
        );
    }
    ...
    public List<ForeignKey<TaskStatusesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TaskStatusesRecord, ?>>asList(
            Keys.FK_TASK_STATUSES_PROJECTS_1
        );
    }
