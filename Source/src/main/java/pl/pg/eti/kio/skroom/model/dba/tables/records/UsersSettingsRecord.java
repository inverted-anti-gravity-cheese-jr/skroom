...
public class UsersSettingsRecord extends UpdatableRecordImpl<UsersSettingsRecord> implements Record5<Integer, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = -51533004;
     ...
     */
    @Override
    public UsersSettingsRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersSettingsRecord(Integer id, Integer userId, Integer recentProjectId, Integer userStoriesPerPage, Integer tasksPerPage) {
        super(UsersSettings.USERS_SETTINGS);
